...
impl LocalBufferStore {
    fn save_local_buffer(
        ...
        if buffer
            .file()
            .is_some_and(|file| file.persistence_state() == PersistenceState::New)
        {
            ...
            let new_file = if let Some(entry) = snapshot_entry {
                File {
                    ...
                    persistence_state: match entry.mtime {
                        ...
                        None => old_file.persistence_state,
                    },
                }
            } else {
                File {
                    ...
                    persistence_state: PersistenceState::make_deleted(old_file.mtime()),
                }
            };
